...
var CACHE_TIMEOUT_SHORT = 1;//30;  //for topic, comments - 30 mins
var CACHE_TIMEOUT_MEDIUM = 1;//60 * 6;  //for tvprograms, num checkins ~ 6 hours
var CACHE_TIMEOUT_LONG = 1;//60 * 24 * 30;  //for levels, badges, ~ 1 month
